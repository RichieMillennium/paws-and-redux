...
export const DogTags = () => {
  ...
  return (
    <div className="sticky top-[6.5rem] xs:top-[12rem] sm:top-[8.5rem] md:top-[6.5rem] xs:bg-red-100 sm:bg-orange-100 md:bg-green-100 flex flex-wrap justify-center place-content-start h-40 overflow-auto bg-gray-100 my-8 border rounded-b-lg border-gray-300">
      {breeds.map(breed => {
        return (
